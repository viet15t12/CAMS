...
#table(
  ...
  [ARP], [Address Resolution Protocol], [Giao thức phân giải địa chỉ IPv4 sang địa chỉ MAC],
  ...
  [PAT], [Port Address Translation], [Biên dịch địa chỉ theo cổng, còn gọi là NAT Overload],
