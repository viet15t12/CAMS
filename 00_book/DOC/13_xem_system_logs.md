...
| **From / To (UTC)** | Khoảng thời gian UTC dạng ISO, ví dụ `2026-08-26T18:00`. Hai đầu khoảng thời gian đều được tính. |
| **Latest N per host** | Chỉ giữ N bản ghi mới nhất của mỗi host sau các điều kiện khác; `0` là không giới hạn, tối đa `500`. |
